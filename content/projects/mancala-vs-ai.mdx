...
All the code for this specific Mancala implementation can be found [here](https://github.com/rfhcs/csci-3202-final-project/). You can skip this section if you just want to read about the algorithms we'll be using.
...
<FootRef className="text-xs mb-4">
  This was an undergraduate final project for Introduction to Artificial Intelligence at the University of Colorado Boulder.
  
  All this work is informally published for educational purposes.
</FootRef>


<RefLink href="https://github.com/rfhcs/csci-3202-final-project/tree/main" children="github repo" />
<RefLink href="https://en.wikipedia.org/wiki/Minimax" children="wikipedia minimax" />
<RefLink href="https://en.wikipedia.org/wiki/Alpha%E2%80%93beta_pruning" children="wikipedia alpha-beta" />
