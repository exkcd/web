...
export default function Resume() {
  return (
    <motion.main className="mb-16 space-y-16" variants={VARIANTS_CONTAINER} initial="hidden" animate="visible">
          ...
          {WORK_EXPERIENCE.map((job) => (
            ...
            >
              <Spotlight
                ...
                size={64}
              />
              <div className="relative h-full w-full rounded-[15px] bg-zinc-50 p-4 dark:bg-zinc-950">
        ...
        <div className="flex flex-col space-y-0">
          ...
          >
            {PROJECTS.map((project) => (
              <Link key={project.name} className="-mx-3 rounded-xl px-3 py-3" href={project.link} data-id={project.id}>
